    ...
    if (backendEnabled) {
        return {
            ...
            content: tool.schema
                ...
                .describe("One or more ranges to compress; summaries are generated by backend"),
        }
    }
...
export function createCompressRangeTool(ctx: ToolContext): ReturnType<typeof tool> {
    ...
    const formatExtension = backendEnabled ? RANGE_BACKEND_FORMAT_EXTENSION : RANGE_FORMAT_EXTENSION
